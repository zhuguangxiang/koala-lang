...
static struct opcode {
  ...
  OPCODE(OP_GET_FIELD_VALUE, 2),
  OPCODE(OP_SET_FIELD_VALUE, 2),
...
struct opmap {
  ...
  OP_MAP(OP_BAND, __bitand__),
  OP_MAP(OP_BOR,  __bitor__),
  OP_MAP(OP_BXOR, __bitxor__),
  OP_MAP(OP_BNOT, __bitnor__),

  OP_MAP(OP_AND, __and__),
  OP_MAP(OP_OR,  __or__),
  OP_MAP(OP_NOT, __not__),
