...
char *atom(char *s) { return atom_nstr(s, strlen(s)); }
...
void init_atom(void) { hashmap_init(&atom_tbl, _atom_equal_); }

void fini_atom(void) { hashmap_fini(&atom_tbl, _atom_free_, NULL); }
