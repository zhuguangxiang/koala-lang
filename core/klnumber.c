...
static int kl_number_class(void *ks)
{
...
static int kl_number_str(void *ks)
{
    // KlValue self = kl_pop_value(ks);
    // int32 hash = mem_hash(&self, sizeof(uintptr));
    // kl_push_int32(ks, hash);
...
void init_number_types(void)
{
    ...
    int8_vtbl = int8_type.vtbl;
    int16_vtbl = int16_type.vtbl;
    int32_vtbl = int32_type.vtbl;
    int64_vtbl = int64_type.vtbl;
    float32_vtbl = float32_type.vtbl;
    float64_vtbl = float64_type.vtbl;
    bool_vtbl = bool_type.vtbl;
