...
X(OP_NOP,                    FORMAT_Ax,   "[op:8][0:24]")
X(OP_MOVE,                   FORMAT_AxBx, "[op:8][Rd:12][Rs:12]         Rd = Rs")
X(OP_CAST_INTF,              FORMAT_ABC,  "[op:8][Rd:8][Rs:8][Idx:8]    Rd = (intf)Rs")

X(OP_CONST,                  FORMAT_AxBx, "[op:8][Rd:12][Idx:12]        Rd = CP[Idx]")
X(OP_CONST_NONE,             FORMAT_Ax,   "[op:8][Rd:12][0:12]          Rd = None")
X(OP_CONST_FALSE,            FORMAT_Ax,   "[op:8][Rd:12][0:12]          Rd = False")
X(OP_CONST_TRUE,             FORMAT_Ax,   "[op:8][Rd:12][0:12]          Rd = True")
X(OP_CONST_EMPTY_STR,        FORMAT_Ax,   "[op:8][Rd:12][0:12]          Rd = \"\"")
X(OP_CONST_EMPTY_LIST,       FORMAT_Ax,   "[op:8][Rd:12][0:12]          Rd = []")
X(OP_CONST_EMPTY_DICT,       FORMAT_Ax,   "[op:8][Rd:12][0:12]          Rd = {}")

X(OP_CONST_INT_M1,           FORMAT_Ax,   "[op:8][Rd:12][0:12]          Rd = -1")
X(OP_CONST_INT_0,            FORMAT_Ax,   "[op:8][Rd:12][0:12]          Rd = 0")
X(OP_CONST_INT_1,            FORMAT_Ax,   "[op:8][Rd:12][0:12]          Rd = 1")
X(OP_CONST_INT_IMM,          FORMAT_ABxx, "[op:8][Rd:8][Imm:16]         Rd = Imm")

X(OP_CONST_FLOAT_0,          FORMAT_Ax,   "[op:8][Rd:12][0:12]          Rd = 0.0")
X(OP_CONST_FLOAT_N0,         FORMAT_Ax,   "[op:8][Rd:12][0:12]          Rd = -0.0")
X(OP_CONST_FLOAT_NAN,        FORMAT_Ax,   "[op:8][Rd:12][0:12]          Rd = float('nan')")
X(OP_CONST_FLOAT_INF,        FORMAT_Ax,   "[op:8][Rd:12][0:12]          Rd = float('inf')")
X(OP_CONST_FLOAT_NINF,       FORMAT_Ax,   "[op:8][Rd:12][0:12]          Rd = float('-inf')")
...
X(OP_INT_NEG,                FORMAT_ABC,  "[op:8][Rd:8][Rs:8][0:8]   Rd = -Rs")
...
X(OP_INT_NOT,                FORMAT_ABC,  "[op:8][Rd:8][Rs:8][0:8]   Rd = ~Rs")
...
X(OP_FLOAT_NEG,              FORMAT_ABC,  "[op:8][Rd:8][Rs:8][0:8]   Rd = -Rs")
