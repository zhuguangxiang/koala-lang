...
X(OP_UINT_DIV,             FORMAT_ABC,     "[op:8][Rd:8][Rs:8][Rt:8]", "Rd = Rs / Rt")
X(OP_UINT_DIV_IMM,         FORMAT_ABC,     "[op:8][Rd:8][Rs:8][Imm:8]", "Rd = Rs / Imm")
X(OP_UINT_MOD,             FORMAT_ABC,     "[op:8][Rd:8][Rs:8][Rt:8]", "Rd = Rs % Rt")
X(OP_UINT_MOD_IMM,         FORMAT_ABC,     "[op:8][Rd:8][Rs:8][Imm:8]", "Rd = Rs % Imm")
X(OP_UINT_SHR,             FORMAT_ABC,     "[op:8][Rd:8][Rs:8][Rt:8]", "Rd = Rs >> Rt")
X(OP_UINT_SHR_IMM,         FORMAT_ABC,     "[op:8][Rd:8][Rs:8][Imm:8]", "Rd = Rs >> Imm")

X(OP_UINT_CMP_LT,           FORMAT_ABC,     "[op:8][Rd:8][Rs:8][Rt:8]", "Rd = (Rs < Rt) ? 1 : 0")
X(OP_UINT_CMP_LT_IMM,       FORMAT_ABC,     "[op:8][Rd:8][Rs:8][Imm:8]", "Rd = (Rs < Imm) ? 1 : 0")
X(OP_UINT_CMP_LE,           FORMAT_ABC,     "[op:8][Rd:8][Rs:8][Rt:8]", "Rd = (Rs <= Rt) ? 1 : 0")
X(OP_UINT_CMP_LE_IMM,       FORMAT_ABC,     "[op:8][Rd:8][Rs:8][Imm:8]", "Rd = (Rs <= Imm) ? 1 : 0")
X(OP_UINT_CMP_GT,           FORMAT_ABC,     "[op:8][Rd:8][Rs:8][Rt:8]", "Rd = (Rs > Rt) ? 1 : 0")
X(OP_UINT_CMP_GT_IMM,       FORMAT_ABC,     "[op:8][Rd:8][Rs:8][Imm:8]", "Rd = (Rs > Imm) ? 1 : 0")
X(OP_UINT_CMP_GE,           FORMAT_ABC,     "[op:8][Rd:8][Rs:8][Rt:8]", "Rd = (Rs >= Rt) ? 1 : 0")
X(OP_UINT_CMP_GE_IMM,       FORMAT_ABC,     "[op:8][Rd:8][Rs:8][Imm:8]", "Rd = (Rs >= Imm) ? 1 : 0")
...
X(OP_BINARY_CMP_EQ,          FORMAT_ABC,    "", "")
X(OP_BINARY_CMP_NE,          FORMAT_ABC,    "", "")
X(OP_BINARY_CMP_LT,          FORMAT_ABC,    "", "")
X(OP_BINARY_CMP_GT,          FORMAT_ABC,    "", "")
X(OP_BINARY_CMP_LE,          FORMAT_ABC,    "", "")
X(OP_BINARY_CMP_GE,          FORMAT_ABC,    "", "")

X(OP_WIDE,                   FORMAT_Ax,     "", "")
X(OP_RAISE,                  FORMAT_Ax,     "", "")
X(OP_VM_MAX,                 FORMAT_NONE,   "", "")

X(OP_IR_LOCAL,               FORMAT_NONE,   "", "")
X(OP_IR_CALL,                FORMAT_NONE,   "", "")
X(OP_IR_JMP_COND,            FORMAT_NONE,   "", "")
X(OP_IR_PHI,                 FORMAT_NONE,   "", "")
X(OP_MAX,                    FORMAT_NONE,   "", "")
